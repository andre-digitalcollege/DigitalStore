      ...
      <div>
         <header style={{ display: "flex", flexDirection: "column" }}>
            <div style={{ padding: "34px 102px", flexDirection: "row", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
               ...
               <div style={{ width: "280px", height: "44px", fontSize: "36.4px", letterSpacing: "-0.01em", color: "#C92071", fontWeight: "600" }}><img style={{ width: "33px", height: "33px", top: "38px", marginRight: "8px"  }} alt='logo' src="/img/logodigital.png" />Digital Store</div>
               ...
               <svg className='svg' onClick={{}} width="33" height="29" viewBox="0 0 33 29" fill="none" xmlns="http://www.w3.org/2000/svg">
